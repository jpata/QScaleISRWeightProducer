...
class Q2WeightsTTbar : public edm::EDProducer{
   public:
      explicit Q2WeightsTTbar(const edm::ParameterSet&);
      ~Q2WeightsTTbar();
...
void
Q2WeightsTTbar::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
  using namespace std;
  ...
  auto_ptr<std::vector<double> > Q2WeightsTTbar (new std::vector<double>);

  Q2WeightsTTbar->push_back(weight_up);

  Q2WeightsTTbar->push_back(weight_down);

  iEvent.put(Q2WeightsTTbar);
}

// ------------ method called once each job just before starting event loop  ------------
void 
Q2WeightsTTbar::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
Q2WeightsTTbar::endJob() 
{
}

// ------------ method called when starting to processes a run  ------------
void 
Q2WeightsTTbar::beginRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
void 
Q2WeightsTTbar::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
Q2WeightsTTbar::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
Q2WeightsTTbar::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
Q2WeightsTTbar::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(Q2WeightsTTbar);
